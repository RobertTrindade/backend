  ...
  import { Create, CreateDocument,CreateExtra } from './dtos/create.dto';
  ...
  class Validator extends BaseValidator {
    ...
    public createDocument: RequestHandler = (req, res, next) => {
      this.validateSchema(req, next, 'body', CreateDocument);
    };

    public createExtras: RequestHandler = (req, res, next) => {
      this.validateSchema(req, next, 'body', CreateExtra);
    };
